...
<body>
	...
	<form method="post" action="<?php echo $this->getAction()->getUrl('product','save')?>">
		<table border="1" width="100%" cellspacing="4">
			...
			<tr>
				...
				<td>
					...
					<button type="button"><a href="<?php echo $this->getAction()->getUrl('product','grid')?>">Cancel</a></button> 
